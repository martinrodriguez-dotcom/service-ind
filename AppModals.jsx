        ...
        <ModalComp 
            ...
            onClose={() => { 
                if(modalType !== 'force_password_change') {
                    ...
                    setShowAllEvents(false); // Reseteamos la vista al cerrar el modal
                }
            }} 
            ...
            <div className="max-w-md mx-auto w-full">
                ...
                {modalType === 'register_user' && (
                    <form onSubmit={handleRegisterUser} className="space-y-4">
                        <input 
                            type="text" 
                            required 
                            className="input-premium px-4 py-3 w-full text-sm font-bold" 
                        ...
                        />
                        <select 
                            className="input-premium px-4 py-3 w-full text-sm font-bold bg-white appearance-none" 
                            value={newUser.role} 
                        ...
                        {['operario', 'gerente'].includes(newUser.role) && (
                            <select 
                                className="input-premium px-4 py-3 w-full text-sm font-bold bg-white appearance-none border-yellow-400" 
                        ...
                        <button type="submit" className="btn-accent w-full px-5 py-3 text-sm font-black uppercase mt-2 shadow-md">
                            CREAR ACCESO
                        </button>
                    </form>
                )}
                ...
                {modalType === 'edit_user' && (
                    <div className="space-y-4">
                        ...
                        <button 
                            ...
                            className="btn-accent w-full px-5 py-3 text-sm font-black uppercase mt-2 shadow-md"
                        >
                            GUARDAR CAMBIOS
                        </button>
                    </div>
                    ...
                    <div className="space-y-6 text-center">
                        ...
                        <form onSubmit={handleChangePassword} className="space-y-4">
                            <input 
                                type="password" 
                                required 
                                className="input-premium px-4 py-3 w-full text-center text-lg tracking-widest font-black" 
                            ...
                            />
                            <button type="submit" className="btn-accent w-full px-5 py-4 text-sm font-black shadow-lg uppercase">
                                ACTIVAR
                            </button>
                        </form>
                    </div>
                ...
                {modalType === 'company' && (
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <input 
                                className="input-premium px-4 py-3 w-full text-xs font-bold" 
                                type="number" 
                        ...
                        <button onClick={handleAddCompany} className="btn-accent w-full px-5 py-3 text-sm font-black mt-2 uppercase shadow-md">
                            REGISTRAR CLIENTE
                        </button>
                    </div>
                )}
                ...
                {modalType === 'edit_company' && (
                    <div className="space-y-4">
                        ...
                        <button onClick={handleEditCompanySubmit} className="btn-premium w-full px-5 py-3 text-sm font-black mt-2 uppercase">
                            Guardar Cambios
                        </button>
                    </div>
                )}
                ...
                {modalType === 'vehicle' && (
                    <div className="space-y-4">
                        <input 
                            className="input-premium px-4 py-4 w-full text-lg font-black italic" 
                        ...
                        <button onClick={handleAddVehicle} className="btn-premium w-full px-5 py-4 text-sm font-black mt-2 uppercase shadow-md">
                            Vincular Equipo
                        </button>
                    </div>
                )}
                ...
                {modalType === 'edit_vehicle' && (
                    <div className="space-y-4">
                        ...
                        <button onClick={handleEditVehicleSubmit} className="btn-premium w-full px-5 py-4 text-sm font-black mt-2 uppercase shadow-md">
                            Actualizar Datos
                        </button>
                    </div>
                )}
                ...
                {modalType === 'log' && (
                    <div className="space-y-6">
                        <div className="flex items-center gap-2 justify-center bg-emerald-50 border border-emerald-100 p-2 rounded-lg text-emerald-600">
                        ...
                        <div className={`grid ${isTank ? 'grid-cols-1' : 'grid-cols-2'} gap-4 text-center`}>
                            {!isTank && (
                                <div className="space-y-2">
                                    ...
                                    <input 
                                        type="number" 
                                        className="input-premium px-4 py-4 w-full text-2xl md:text-3xl text-center font-black" 
                        ...
                        <textarea 
                            className="input-premium px-5 py-4 w-full h-32 md:h-40 text-sm font-bold resize-none" 
                            placeholder={isTank ? "REMITO DEL PROVEEDOR..." : "NOTAS DE LA JORNADA..."} 
                            onChange={e => setForm(prev => ({...prev, nota: e.target.value.toUpperCase()}))} 
                        />
                        <button onClick={handleDailyLog} className="btn-accent w-full px-5 py-4 text-base md:text-lg font-black uppercase shadow-lg">
                ...
                {modalType === 'service' && !isTank && (
                    <div className="space-y-6">
                        <div className="bg-slate-900 p-6 md:p-8 rounded-2xl text-center text-white border-t-[6px] border-t-yellow-400 shadow-xl relative overflow-hidden">
                            <div className="absolute top-2 right-2 flex items-center gap-1 text-emerald-400 bg-emerald-400/10 px-2 py-1 rounded-md">
                                <Icon name="check" size={10}/>
                                <span className="text-[8px] font-black uppercase tracking-widest">Offline Ready</span>
                            </div>
                        ...
                        <textarea 
                            className="input-premium px-4 py-3 w-full h-24 md:h-32 text-xs md:text-sm font-bold resize-none" 
                            placeholder="RECOMENDACIONES TÉCNICAS..." 
                            onChange={e => setForm(prev => ({...prev, nota: e.target.value.toUpperCase()}))} 
                        />
                        <button onClick={handleServiceReset} className="btn-accent w-full px-5 py-4 text-sm md:text-base font-black uppercase shadow-lg">
                            Cerrar Ciclo
                        </button>
                    </div>
                )}
                ...
                {modalType === 'downtime' && (
                    <div className="space-y-6 text-center px-4">
                        <div className="w-20 h-20 bg-red-100 rounded-full flex items-center justify-center mx-auto border-4 border-red-500 animate-pulse shadow-xl">
                        ...
                        <textarea 
                            className="input-premium px-5 py-4 w-full h-32 md:h-40 text-sm text-red-600 border-red-200 bg-red-50/50 font-bold resize-none" 
                            placeholder="DETALLE O MOTIVO DEL EVENTO..." 
                            onChange={e => setForm(prev => ({...prev, motivo: e.target.value.toUpperCase()}))} 
                        />
                        <button onClick={handleConfirmDowntime} className="btn-premium w-full px-5 py-4 bg-red-600 text-base md:text-lg font-black uppercase shadow-xl hover:bg-red-700 transition-all">
                            EMITIR REPORTE
                        </button>
                    </div>
                )}
                ...
                {modalType === 'repair_finish' && (
                    <div className="space-y-6 text-center px-4">
                        ...
                        <textarea 
                            ...
                            onChange={e => setForm(prev => ({...prev, nota: e.target.value.toUpperCase()}))} 
                        />
                        <button onClick={handleRepairSubmit} className="btn-premium w-full px-5 py-4 bg-emerald-600 hover:bg-emerald-700 text-base md:text-lg font-black uppercase shadow-xl">
                            DAR DE ALTA UNIDAD
                        </button>
                    </div>
                )}
                ...
                {modalType === 'historical' && !isTank && (
                    <div className="space-y-4">
                        ...
                        <button onClick={handleHistoricalData} className="btn-premium w-full px-5 py-3 text-xs font-black uppercase mt-2 shadow-md">
                ...
                {modalType === 'qr' && (
                    <div className="space-y-6 text-center flex flex-col items-center pt-4">
                        ...
                        <div className="p-6 md:p-8 bg-white rounded-2xl shadow-xl border-[4px] border-slate-900" id={`qr-container-${activeVehicleId}`}></div>
                        <p className="text-lg md:text-xl font-black text-slate-800 uppercase tracking-widest">{activeVehicle?.nombre}</p>
                        <button onClick={handlePrintQR} className="btn-premium w-full px-5 py-4 text-sm font-black uppercase shadow-xl mt-4">
                            IMPRIMIR ETIQUETA
                        </button>
                    </div>
                )}
                ...
                {modalType === 'event_detail' && activeEvent && (
                    <div className="space-y-6">
                        <div className="bg-slate-900 p-6 rounded-2xl text-center text-white shadow-xl border-t-[6px] border-t-blue-500">
                        ...
                        {role === 'admin' ? (
                            <div className="space-y-4">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <input 
                                        type="number" 
                                        className="input-premium px-4 py-3 w-full text-sm font-bold text-emerald-600" 
                                        value={form.costo || ''} 
                                        onChange={e => setForm(prev => ({...prev, costo: e.target.value}))} 
                                    />
                                </div>
                                ...
                                <div className="space-y-1">
                                    ...
                                    <textarea 
                                        className="input-premium px-4 py-3 w-full h-24 text-sm font-bold resize-none" 
                                ...
                                <button onClick={handleEditEventSubmit} className="btn-accent w-full px-5 py-4 text-sm font-black uppercase shadow-lg">
                                    ACTUALIZAR REGISTRO
                                </button>
                            </div>
                        ) : (
                ...
                {modalType === 'category_events' && activeCategoryEvents && (
                    <div className="space-y-6">
                        <div className="bg-slate-900 p-6 rounded-2xl text-center text-white shadow-xl border-t-[6px] border-t-yellow-400">
                        ...
                        <button 
                            ...
                            className="btn-premium w-full px-5 py-4 text-sm font-black uppercase shadow-lg flex items-center justify-center gap-3"
                        >
